...
config :phoenix_vite, PhoenixVite.Npm,
  # package.json lives at the project root (LiveVue's layout) and references
  # deps/* via file: specs, so npm has to run there — not in config/.
...
config :telegram_voice_transcriber_ash, TelegramVoiceTranscriberAshWeb.Endpoint,
  ...
  render_errors: [
    formats: [
      html: TelegramVoiceTranscriberAshWeb.ErrorHTML,
      json: TelegramVoiceTranscriberAshWeb.ErrorJSON
    ],
    layout: false
  ],
  pubsub_server: TelegramVoiceTranscriberAsh.PubSub,
  live_view: [signing_salt: "Fmcf8Dk9"]
