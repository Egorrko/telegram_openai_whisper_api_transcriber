---
name: phoenix-livevue-web
description: "Use when working on the web layer: Phoenix, LiveView, and the LiveVue component layer that renders every screen in this project."
metadata:
...
- [live_vue](references/live_vue/live_vue.md)

## Searching Documentation

```sh
mix usage_rules.search_docs "search term" -p phoenix -p phoenix_ecto -p phoenix_html -p phoenix_live_dashboard -p phoenix_live_reload -p phoenix_live_view -p live_vue
```
